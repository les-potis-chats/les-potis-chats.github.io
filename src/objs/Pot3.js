...
Command: npx gltfjsx@6.1.4 pot3.glb
*/
...
export function Pot3(props) {
  const { nodes, materials } = useGLTF('/models/pot3.glb')
  ...
  const [ref] = useCylinder(
    () => ({
      args,
      mass: 10000,
      position: [props.position[0], 0.1, props.position[2]],
    }),
    useRef(null),
  )
  return <>
...
useGLTF.preload('/models/pot3.glb')
